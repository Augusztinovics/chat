<template>
    <div class="profile-updates">
        <div class="profile-updates-body">
            <div class="preview" :class="{'selected': selectedLg == 'HU'}" @click="selectLg('HU')">
                <h4>
                    <span class="icon">
            ...
            <div class="preview mt-2" :class="{'selected': selectedLg == 'SR'}" @click="selectLg('SR')">
                <h4>
                    <span class="icon">
            ...
            <div class="preview mt-2" :class="{'selected': selectedLg == 'EN'}" @click="selectLg('EN')">
                <h4>
                    <span class="icon">
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.selectedLg = this.userStore.lg;
        }
    }
</script>
